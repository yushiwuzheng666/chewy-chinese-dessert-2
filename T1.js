...
! function(t) {
	...
	e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = _, e.set = y, e.setIn = m, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = O, e.mergeIn = w, e.omit = A, e.addDefaults = S;
	/*!
	 * Timm
	 *
	...
	function E(t, e) {
		return e >= t.length || e < 0 ? t : t.slice(0, e)
			.concat(t.slice(e + 1))
	}
	...
	var r = n(37),
		i = n(24);
	t.exports = function(t, e) {
		for (var n = 0, o = (e = r(e, t))
			.length; null != t && n < o;) t = t[i(e[n++])];
	...
	window.tram = function(t) {
		...
		var f = function(t, e, n) {
			...
			N = function(t) {
				...
				var e, n, r = "",
					i = t.split("-");
				for (e = 0; e < i.length; e++) r += i[e].charAt(0)
					.toUpperCase() + i[e].slice(1);
		...
		var P = e.frame = function() {
			...
			j = f(function(e) {
				...
				function d() {
					var t, e, n = [];
					for (t in this.upstream && n.push(this.upstream), this.props)(e = this.props[t])
						.active && n.push(e.string);
			...
			U = f(function(e) {
				...
				e.init = function(t) {
					...
					if (e += "", "#" == (t += "")
						.charAt(0)) return this.startRGB = i(e), this.endRGB = i(t), this.endHex = t, this.begin = 0, void(this.change = 1);
					if (!this.unit) {
						var n = e.replace(E, "");
			...
			B = f(U, function(t, e) {
				t.init = function(t) {
					...
					var e, n, r = !1;
					for (e = this.tweens.length; e--;)(n = this.tweens[e])
						.context && (n.render(t), this.current[n.name] = n.value, r = !0);
		...
		C.transform && (Q.transform = [V], q = {
			...
			skewX: [b],
			skewY: [b]
		}), C.transform && C.backface && (q.z = [I, "translateZ"], q.rotateZ = [b], q.scaleZ = [_], q.perspective = [m]);
		var $ = /ms/,
			Z = /s|\./;
		return t.tram = e
	}(window.jQuery)
			...
			! function(t) {
				Object.keys(t)
					.forEach(function(e) {
						...
						if (void 0 === n(void 0, {
							type: "@@redux/PROBE_UNKNOWN_ACTION_" + Math.random()
								.toString(36)
								.substring(7)
								.split("")
								.join(".")
		...
		i && n.dispatch((0, _.rawDataImported)(i)), u.active || (n.dispatch((0, _.sessionInitialized)({
			...
			reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)")
				...
				ft(t), (0, v.default)(e, function(e, n) {
										...
										dt(d, function(e, o, c) {
											...
											if (W(p, r.mediaQueryKey)) {
												var v = function() {
													...
													K(i, f) || n.dispatch((0, _.eventStateChanged)(c, i))
												};
					...
					.ixSession.eventListeners.length && function(t) {
						var e = function() {
							ft(t)
						};
			...
			}(n), -1 === (e = document.documentElement)
			.className.indexOf(R) && (e.className += " ".concat(R)), n.getState()
			.ixSession.hasDefinedMediaQueries && function(t) {
				D({
					store: t,
					select: function(t) {
	...
	function _t(t) {
		...
		r.dispatch((0, _.instanceAdded)((0, a.default)({
			...
			var n = t.getState()
				.ixParameters;
			t.dispatch((0, _.instanceStarted)(e, 0)), t.dispatch((0, _.animationFrameChanged)(performance.now(), n)), It(t.getState()
				.ixInstances[e], t)
		}(r, g) : (D({
			store: r,
			select: function(t) {
	...
	r.define("brand", t.exports = function(t) {
		...
		function l() {
			...
			t(e)
				.attr("style", n ? "display: none !important;" : "")
		}
		...
		/*return n.ready = function() {
			...
			/\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-webflow-badge"></a>')
					.attr("href", "https://webflow.com?utm_campaign=brandjs"), r = t("<img>")
					...
					.attr("alt", "Made in Webflow"), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i)
				.off(f, l)
				.on(f, l))
		}, n
		*/
	...
	t.exports = function() {
		...
		return t.template = function(e, n, r) {
			...
			var i = RegExp([(n.escape || E)
					.source, (n.interpolate || E)
					.source, (n.evaluate || E)
					.source
				].join("|") + "|$", "g"),
				o = 0,
			...
			e.replace(i, function(t, n, r, i, u) {
				return a += e.slice(o, u)
					.replace(_, y), o = u + t.length, n ? a += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? a += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : i && (a += "';\n" + i + "\n__p+='"), t
	...
	r.define("edit", t.exports = function(t, e, n) {
		...
		return f ? s() : u.search ? (/[?&](edit)(?:[=&?]|$)/.test(u.search) || /\?edit$/.test(u.href)) && s() : o.on(c, l)
			.triggerHandler(c), {}
	})
}, function(t, e, n) {
	"use strict";
			...
			function t(t) {
				...
				document.addEventListener("keydown", function(n) {
					...
					o(t.target) && t.target.hasAttribute("data-wf-focus-visible") && (n = !0, window.clearTimeout(r), r = window.setTimeout(function() {
						...
						.getAttribute("data-wf-focus-visible") && e.removeAttribute("data-wf-focus-visible"))
				}, !0)
			}
			return {
				ready: function() {
					...
					if ("undefined" != typeof document && document.body.hasAttribute("data-wf-focus-within")) try {
						...
						r = function(r) {
							...
							i || (window.requestAnimationFrame(function() {
								i = !1, "blur" === r.type && Array.prototype.slice.call(t(r.target))
									.forEach(n), "focus" === r.type && Array.prototype.slice.call(t(r.target))
									.forEach(e)
							}), i = !0)
	...
	var r = window.jQuery,
		...
		a = {
			...
			intro: function(t, e) {
				e.__wf_intro || (e.__wf_intro = !0, r(e)
					.triggerHandler(i.types.INTRO))
			},
			outro: function(t, e) {
				e.__wf_intro && (e.__wf_intro = null, r(e)
					.triggerHandler(i.types.OUTRO))
			}
		};
	i.triggers = {}, i.types = {
		INTRO: "w-ix-intro.w-ix",
	...
	(t.exports = function(t, e, n, c) {
		...
		i(n) && ("Symbol(" === String(E)
			.slice(0, 7) && (E = "[" + String(E)
				.replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!o(n, "name") || f && n.name !== E) && a(n, "name", E), (s = d(n))
			.source || (s.source = p.join("string" == typeof E ? E : ""))), t !== r ? (l ? !h && t[e] && (v = !0) : delete t[e], v ? t[e] = n : a(t, e, n)) : v ? t[e] = n : u(e, n)
	...
	var r, i = n(29),
		...
		h = function() {
			...
			var t, e;
			h = "undefined" != typeof document ? document.domain && r ? v(r) : ((e = s("iframe"))
				.style.display = "none", c.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document)
				.open(), t.write(p("document.F=Object")), t.close(), t.F) : v(r);
	...
	var r = n(3)
		.IX2EngineActionTypes.IX2_RAW_DATA_IMPORTED;
	e.ixData = function() {
	...
	t.exports = function(t, e, n, E, g, _) {
		...
		if (w && !T) return _ || (_ = new r), y || f(t) ? i(t, e, n, E, g, _) : o(t, e, I, n, E, g, _);
		if (!(n & l)) {
	...
	(function(t) {
		var r = n(99),
			...
			u = function() {
				try {
					var t = o && o.require && o.require("util")
						.types;
					...
					switch (u) {
						...
						case ut:
							var g = lt[u],
								...
								I = n.aValue;
							xt(t, g, o), a(t, g, I >= 1 ? "rgb(".concat(_, ",")
								.concat(y, ",")
								.concat(m, ")") : "rgba(".concat(_, ",")
								.concat(y, ",")
								.concat(m, ",")
								.concat(I, ")"));
							break;
	...
	function _t(t) {
		...
		return null == N || null == C ? [] : _.IS_BROWSER_ENV && u ? d(C)
			.filter(function(t) {
				return u.contains(t)
			}) : x === F ? d(N, C) : x === k ? p(d(N))
			.filter(E(C)) : x === G ? h(d(N))
			.filter(E(C)) : d(C)
	}
	var yt = /px/,
		mt = function(t, e) {
	...
	function xt(t, e, n) {
		if (_.IS_BROWSER_ENV) {
			...
			if (r) {
				...
				if (a) {
					var u = a.split(B)
						.map(ft); - 1 === u.indexOf(r) && o(t, U, u.concat(r)
						.join(B))
				} else o(t, U, r)
			}
		}
		...
		if (_.IS_BROWSER_ENV) {
			...
			if (r) {
				var i = n.getStyle,
					o = n.setStyle,
					a = i(t, U);
				a && -1 !== a.indexOf(r) && o(t, U, a.split(B)
					.map(ft)
					.filter(function(t) {
						return t !== r
					})
		...
		b = function(t, e) {
			...
			for (var S = 0, R = i.length; S < R; S++) {
				...
				if (0 === S && (_ = C[0]), A >= N) {
					...
					var L = i[S + 1],
						D = L && A !== N;
					m = D ? L.actionItems[0] : null, D && (I = N / 100, b = (L.keyframe - N) / 100)
				}
			}
			var P = {};
			if (_ && !m)
				for (var M = 0, j = a.length; M < j; M++) {
					var F = a[M];
					P[F] = y(s, F, _.config)
				} else if (_ && m && void 0 !== I && void 0 !== b)
					for (var k = (w - I) / b, G = _.config.easing, X = h(G, k, f), V = 0, U = a.length; V < U; V++) {
						var W = a[V],
							B = y(s, W, _.config),
	...
	t.exports = function(t, e, n, c) {
		if (!a(t)) return t;
		for (var s = -1, f = (e = i(e, t))
			.length, l = f - 1, d = t; null != d && ++s < f;) {
			var p = u(e[s]),
				v = n;
	...
	Object.defineProperty(e, "__esModule", {
		...
		if (e) {
			...
			return '[data-w-id="'.concat(r, '"], [data-w-id^="')
				.concat(r, '_instance"]')
		}
		return n
	...
	var c, s, f, l = u(n(30)),
		...
		Et = (0, l.default)({}, ot, {
			handler: (f = function(t, e) {
				...
				return !t.store.getState()
					.ixData.events[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === j === n ? (tt(t), (0, l.default)({}, e, {
						triggered: !0
					})) : e
			}, function(t, e) {
				var n = (0, l.default)({}, e, {
		...
		gt = (r = {}, (0, o.default)(r, R, vt()), (0, o.default)(r, x, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, {
			...
			handler: et(Z, pt(function(t, e) {
				...
				r = (n = t)
					.store, i = n.event.action.config.autoStopEventId, Boolean(J(r, i)) ? 1 === o && tt(t) : tt(t)
			}))
		}), (0, o.default)(r, I, {
			types: "click",
			handler: et(Z, pt(function(t, e) {
	...
	t.exports = function(t) {
		return i(function(e) {
			...
			return function() {
				var t = arguments,
					r = t[0];
				if (E && 1 == t.length && u(r)) return E.plant(r)
					.value();
	...
	"use strict";
	n(4)
		.define("touch", t.exports = function(t) {
			var e = {},
	...
	i.define("forms", t.exports = function(t, e) {
		...
		function m(e, n) {
			...
			i.done = a.find("> .w-form-done"), i.fail = a.find("> .w-form-fail"), i.fileUploads = a.find(".w-file-upload"), i.fileUploads.each(function(e) {
				! function(e, n) {
					...
					if (l.find(".w-icon-file-upload-icon")
						.attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove")
						.attr("aria-hidden", "true"), g) f.on("click", function(t) {
						t.preventDefault()
		...
		function T(e, n) {
			var r = null;
			return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])')
				.each(function(i, o) {
					var a = t(o),
						u = a.attr("type"),
					...
					if ("checkbox" === u) s = a.is(":checked");
						...
						s = e.find('input[name="' + a.attr("name") + '"]:checked')
							.val() || null
					}
		...
		s.ready = s.design = s.preview = function() {
			! function() {
				o = t("html")
					.attr("data-wf-site"), u = "https://webflow.com/api/v1/form/" + o, d && u.indexOf("https://webflow.com") >= 0 && (u = u.replace("https://webflow.com", "http://formdata.webflow.com"));
				if (c = "".concat(u, "/signFile"), !(n = t(p + " form"))
					.length) return;
				n.each(m)
			}(), g || a || function() {
				...
				f.on("change", p + ' form input[type="checkbox"]:not(.w-checkbox-input)', function(e) {
					...
					t('input[name="'.concat(e.target.name, '"]:not(')
					...
					var n = t(e.target);
					n.hasClass("w-radio-input") || n.siblings(".w-radio-input")
					...
					f.on("focus", p + ' form input[type="'.concat(i, '"]:not(') + o + ")", function(e) {
						t(e.target)
							.siblings(o)
							.addClass("w--redirected-focus"), t(e.target)
		...
		function w(e) {
			...
			var n = e.form,
				r = {
					...
					trackingCookies: document.cookie.split("; ")
						.reduce(function(t, e) {
							var n = e.split("="),
								r = n[0];
							if (r in O) {
	...
	t.exports = function(t, e) {
		...
		try {
			for (var a, u = t[Symbol.iterator](); !(r = (a = u.next())
				.done) && (n.push(a.value), !e || n.length !== e); r = !0);
		} catch (t) {
			i = !0, o = t
		} finally {
			try {
	...
	r.define("navbar", t.exports = function(t, e) {
		...
		function A(n, r) {
			...
			a || (a = t.data(r, E, {
				...
				return function(n) {
					var r = t(n.target);
					c && r.closest(".w-editor-bem-EditorOverlay")
						.length || P(e, r)
				}
			}(a);
			...
			s && "/" === s.attr("href") && null == s.attr("aria-label") && s.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(E), a.button.off(E), a.menu.off(E), x(a), u ? (R(a), a.el.on("setting" + E, function(t) {
				...
				if (e.overlay) return;
				e.overlay = t(h)
					.appendTo(e.el), e.overlay.attr("id", e.overlayContainerId), e.parent = e.menu.parent(), V(e, !0)
		...
		s.ready = s.design = s.preview = function() {
			if (u = v && r.env("design"), c = r.env("editor"), n = t(document.body), !(a = d.find(E))
				.length) return;
		...
		function G(t, e) {
			if (!t.open) {
				...
				if (M(0, s), b.intro(0, s), r.redraw.up(), u || d.on("click" + E, t.outside), e) v();
					...
					if (t.overlay && (T = t.menu.prev(), t.overlay.show()
						.append(t.menu)), n.animOver) return f(t.menu)
						.add(l)
						.set({
							x: n.animDirect * a,
							height: i
		...
		function V(t, e) {
			if (t.open) {
				...
				var n = t.config;
				if (("none" === n.animation || !f.support.transform || n.duration <= 0) && (e = !0), b.outro(0, t.el[0]), d.off("click" + E, t.outside), e) return f(t.menu)
					.stop(), void c();
				var r = "transform " + n.duration + "ms " + n.easing2,
					i = t.menu.outerHeight(!0),
					o = t.menu.outerWidth(!0),
					a = t.el.height();
				if (n.animOver) f(t.menu)
					.add(r)
					.start({
						x: o * n.animDirect
					})
			...
			function c() {
				t.menu.height(""), f(t.menu)
					.set({
						x: 0,
						y: 0
					}), t.menu.each(k), t.links.removeClass(I), t.dropdowns.removeClass(_), t.dropdownToggle.removeClass(y), t.dropdownList.removeClass(m), t.overlay && t.overlay.children()
					.length && (T.length ? t.menu.insertAfter(T) : t.menu.prependTo(t.parent), t.overlay.attr("style", "")
						.hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
			}
		}
		return s
	})
	...
	.init({
		"events": {
			...
			"e-44": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|c8c3641a-8dd6-a98c-b9ca-bbb493731277",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-46": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|84df62fe-1175-90bd-24c5-20d88011e065",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-48": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|0ba136e4-1a48-8741-a888-c7595cd19375",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-50": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|1eec2ba6-e4df-698d-21ca-a0ecbfccee24",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-52": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|a3db3f63-2454-20bc-a4fb-e4bd3f92c9ff",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-54": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164485069817841|75883aad-744f-ce83-458f-71e4205cd4a4",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-56": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164485069817841|c60e756d-e06e-d42c-0164-6b7b6a4ae140",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-58": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448fadd817843|125ac6ec-1cf8-e633-c45b-7c797c275324",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-60": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448fadd817843|0061314c-175c-26f7-0b5e-a7cd4f378cd0",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-62": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448bea1817847|a12b0930-fd52-a246-8560-31053854f64a",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-64": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448bea1817847|f17ad231-bb88-a58b-c388-3ee16f79b3a3",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-66": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164483b0781783e|e8f02398-449d-b0d9-c5bf-b872a4a5c7dd",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-74": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f164485069817841|36201730-7fc3-0b7c-0a68-bd93b7ea387b",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-76": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448fadd817843|710c584d-2071-f0c4-14d4-27a7524ffc97",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-78": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6348fc54f16448bea1817847|34f79aed-5241-52e9-029b-2f7f24f8ca49",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-79": {
				...
				"createdOn": 1666257213347
			}
		},
		"actionLists": {
			"a-15": {
				"id": "a-15",
				"title": "New Timed Animation5",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-15-n",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|fe8e0061-20a3-e89b-3a12-d2616cd741e6"
							},
							"zValue": 0,
							"xUnit": "DEG",
							"yUnit": "DEG",
			...
			"a-2": {
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|accdcb22-f969-0c8e-efe0-24c1cd36cfab"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"createdOn": 1665969241495
			},
			"a-3": {
				"id": "a-3",
				"title": "Banner Scroll 2",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-3-n",
						"actionTypeId": "TRANSFORM_MOVE",
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|a8ea0586-1151-3251-99d1-0b0804d03ace"
							},
							"xValue": -650,
							"xUnit": "px",
							"yUnit": "PX",
			...
			"a-4": {
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164485069817841|9811e05f-5be3-36a0-6ec6-df95839a5277"
							},
							"zValue": 0,
							"xUnit": "DEG",
							"yUnit": "DEG",
				...
				"useFirstGroupAsInitialState": false,
				"createdOn": 1665971144564
			},
			"a-14": {
				"id": "a-14",
				"title": "New Timed Animation3",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-14-n",
						"actionTypeId": "TRANSFORM_MOVE",
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164485069817841|c60e756d-e06e-d42c-0164-6b7b6a4ae141"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448fadd817843|710c584d-2071-f0c4-14d4-27a7524ffc98"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448fadd817843|125ac6ec-1cf8-e633-c45b-7c797c275325"
							},
							"xValue": -200,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448fadd817843|0061314c-175c-26f7-0b5e-a7cd4f378cd1"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448bea1817847|34f79aed-5241-52e9-029b-2f7f24f8ca4a"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448bea1817847|a12b0930-fd52-a246-8560-31053854f64b"
							},
							"xValue": -760,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448bea1817847|f17ad231-bb88-a58b-c388-3ee16f79b3a4"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
			...
			"a": {
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f16448fadd817843|67287b53-416a-325a-3eb0-075aff1badcd"
							},
							"zValue": 0,
							"xUnit": "DEG",
							"yUnit": "DEG",
				...
				"useFirstGroupAsInitialState": false,
				"createdOn": 1665968898704
			},
			"a-12": {
				"id": "a-12",
				"title": "New Timed Animation1",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-12-n",
						"actionTypeId": "TRANSFORM_MOVE",
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164485069817841|dbb6624e-e48e-1632-4fb9-4f156c309c4a"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
			...
			"a-13": {
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164485069817841|75883aad-744f-ce83-458f-71e4205cd4a5"
							},
							"xValue": -420,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"useFirstGroupAsInitialState": true,
				"createdOn": 1665978155017
			},
			"a-16": {
				"id": "a-16",
				"title": "Banner Scroll 3",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-16-n",
						"actionTypeId": "TRANSFORM_MOVE",
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|d7d91c8d-b1a9-a30a-ff59-983a24dfc908"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|df67ad92-8820-9d6a-ed0d-d3f07621dd5a"
							},
							"xValue": 0,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|437a4110-2599-ec37-6fcd-4d15d2079b58"
							},
							"xValue": -500,
							"xUnit": "px",
							"yUnit": "PX",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"id": "6348fc54f164483b0781783e|f42a7e0c-e186-c4a2-70d8-9938d0ddd35a"
							},
							"xValue": -500,
							"xUnit": "px",
							"yUnit": "PX",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"selector": ".div-block-55.page2",
								"selectorGuids": ["f8167773-9e9e-89b6-08e1-f107d318cca0", "0078fddb-5315-c009-bbfe-a88013518032"]
							},
							"widthValue": 10,
							"heightValue": 10,
							"widthUnit": "px",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"selector": ".div-block-55.page3",
								"selectorGuids": ["f8167773-9e9e-89b6-08e1-f107d318cca0", "39db761b-049b-8f4a-4202-fac622b937cc"]
							},
							"widthValue": 10,
							"heightValue": 10,
							"widthUnit": "px",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"selector": ".div-block-55.page4",
								"selectorGuids": ["f8167773-9e9e-89b6-08e1-f107d318cca0", "2ed8816c-f83d-562a-7b6a-7f0ab7cd6050"]
							},
							"widthValue": 10,
							"heightValue": 10,
							"widthUnit": "px",
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"selector": ".div-block-55.page5",
								"selectorGuids": ["f8167773-9e9e-89b6-08e1-f107d318cca0", "e2fa0979-dc79-36ca-b1ca-726622fd90fb"]
							},
							"widthValue": 10,
							"heightValue": 10,
							"widthUnit": "px",
					...
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"selector": ".about-us",
								"selectorGuids": ["fa4781ba-ed52-f59c-d6e2-7ddb6750da65"]
							},
							"heightValue": 0,
							"widthUnit": "PX",
							"heightUnit": "px",
						...
						"config": {
							...
							"target": {
								"selector": ".contactbox",
								"selectorGuids": ["71524dd1-754c-28e7-3486-6766d39efc3b"]
							},
							"heightValue": 0,
							"widthUnit": "PX",
							"heightUnit": "px",
						...
						"config": {
							...
							"target": {
								"selector": ".allourbox",
								"selectorGuids": ["bc68c964-35ca-b51b-14a7-c5b03ec271c2"]
							},
							"heightValue": 0,
							"widthUnit": "PX",
							"heightUnit": "px",
						...
						"config": {
							...
							"target": {
								"selector": ".localbox",
								"selectorGuids": ["4ca89a8a-debc-e805-2643-11e733c758b8"]
							},
							"heightValue": 0,
							"widthUnit": "PX",
							"heightUnit": "px",
						...
						"config": {
							...
							"target": {
								"selector": ".chewy",
								"selectorGuids": ["2cde2e7e-65c3-94f4-46d8-439f1e555299"]
							},
							"heightValue": 100,
							"widthUnit": "PX",
							"heightUnit": "vh",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"duration": 0,
							"target": {
								"selector": ".div-block-55.page1",
								"selectorGuids": ["f8167773-9e9e-89b6-08e1-f107d318cca0", "3754842f-bdf7-6a0d-e8fe-414bd05e69ed"]
							},
							"widthValue": 10,
							"heightValue": 10,
							"widthUnit": "px",
					...
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								...
								"selector": ".div-block-69",
								"selectorGuids": ["ae59b3f9-1cd2-a510-0bf6-a0004ea4a256"]
							},
							"value": "flex"
						}
					}, {
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".link-block-4",
								"selectorGuids": ["140fd630-5e50-451f-cae5-4f21370b9733"]
							},
							"value": "none"
						}
					}, {
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".div-block-23",
								"selectorGuids": ["9e3108bc-569a-b2a3-2b94-0d3ae7a66374"]
							},
							"value": "none"
						}
					}]
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".div-block-70",
								"selectorGuids": ["a7cf08bf-9abe-13a3-7711-5c5e6522b3f0"]
							},
							"value": "flex"
						}
					}, {
